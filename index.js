...
mongoose.connect("mongodb+srv://pramod:pramod115@cluster0.ndhcz.mongodb.net/Endavour?retryWrites=true&w=majority", () => {
...
async function addUser (Cemail, res) {
    ...
    //         fullname: "Ashmin Karki",
    //         adress: "Ktm",
    //         email: "ashmin@gmail.com",
    //         contact_no: 9860648505,
    //         dob: 06/30/2022,
    //     })
    //     console.log(newUser)
    }
...
// addUser("pramodtha115@gmail.com").catch((err) => console.log(err))
//mongoose
...
const mailer = async (recepient,otp) => {
    ...
    const mailOptions = {
      from: "photosharing2078@gmail.com",
      to:`${recepient}`,
      subject: "OTP",
      text:  `${otp}`,
    };
